...
const float m = -0.33266; // calculated from mq2 datasheet sensitivity characteristic
const float b = 1.475366; // calculated from mq2 datasheet sensitivity characteristic
